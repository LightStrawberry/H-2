...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectContext: NSManagedObjectContext = { guard let modelURL = NSBundle.mainBundle().URLForResource(
        ...
        managedObjectModel: model); try coordinator.addPersistentStoreWithType(NSSQLiteStoreType,
